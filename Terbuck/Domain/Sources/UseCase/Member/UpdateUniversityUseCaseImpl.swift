//
//  UpdateUniversityUseCaseImpl.swift
//  Domain
//
...
public struct UpdateUniversityUseCaseImpl: UpdateUniversityUseCase {
    ...
    public func execute(university: String, collegeId: Int) async throws -> Void {
        try await memberRepository.patchUniversityInfo(university: university, collegeId: collegeId)
    }
}