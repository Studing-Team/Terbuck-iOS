...
public final class StoreInfoBottomView: UIView {
...
public extension StoreInfoBottomView {
    func configureData(forModel model: StoreListModel) {
...
private extension StoreInfoBottomView {
    func setupStyle() {
        storeBackgroundView.do {
    ...
    func setupHierarchy() {
        ...
        storeBackgroundView.addSubviews(storeAsyncImageView, storeTitleStackView, storeAddressLabel, benefitCountView)//, rightArrowImageView)
    }
