...
public extension UIFont {
    static var logoBold28: UIFont {
        return UIFont(font: ResourceFontFamily.GmarketSansTTF.bold, size: 28)!
    }
    
    static var logoBold25: UIFont {
        return UIFont(font: ResourceFontFamily.GmarketSansTTF.bold, size: 25)!
    }
    
    static var headBold30: UIFont {
        return UIFont(font: ResourceFontFamily.Pretendard.bold, size: 30)!
    }
    
    static var titleBold26: UIFont {
        return UIFont(font: ResourceFontFamily.Pretendard.bold, size: 26)!
    }
    
    static var titleBold24: UIFont {
